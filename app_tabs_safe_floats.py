        ...
        with tab3:
            ...
            with col1:
                ...
                <div class="metric-box" style="background-color:#e6f4ea;border:1px solid #c8e6c9;">
                    ...
                    <div class="metric-row"><div class="metric-label">Сума по договора:</div><div class="metric-value">{result['CONTRACT_AMOUNT'] if result['CONTRACT_AMOUNT'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">Нормативно признати разходи:</div><div class="metric-value">{result['RECOGNIZED_EXPENSES'] if result['RECOGNIZED_EXPENSES'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">Облагаема сума:</div><div class="metric-value">{result['TAXABLE_FOR_TAX'] if result['TAXABLE_FOR_TAX'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">Осигурителен доход:</div><div class="metric-value">{result['INSURANCE_INCOME'] if result['INSURANCE_INCOME'] is not None else '–'} лв.</div></div>
                </div>
                """, unsafe_allow_html=True)
            ...
            with col2:
                ...
                <div class="metric-box" style="background-color:#e3f2fd;border:1px solid #90caf9;">
                    ...
                    <div class="metric-row"><div class="metric-label">ДОО:</div><div class="metric-value">{result['PENSION_CONTRIBUTION'] if result['PENSION_CONTRIBUTION'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">ДЗПО:</div><div class="metric-value">{result['DZPO_CONTRIBUTION'] if result['DZPO_CONTRIBUTION'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">ЗО:</div><div class="metric-value">{result['HEALTH_CONTRIBUTION'] if result['HEALTH_CONTRIBUTION'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">Общо осигуровки:</div><div class="metric-value">{result['INSURANCE_TOTAL'] if result['INSURANCE_TOTAL'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">ДОД:</div><div class="metric-value">{result['TAX_ADVANCE'] if result['TAX_ADVANCE'] is not None else '–'} лв.</div></div>
                </div>
                """, unsafe_allow_html=True)
            ...
            with col3:
                ...
                <div class="metric-box" style="background-color:#fff3e0;border:1px solid #ffcc80;">
                    ...
                    <div class="metric-row"><div class="metric-label">ДОО:</div><div class="metric-value">{result['EMPLOYER_PENSION'] if result['EMPLOYER_PENSION'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">ДЗПО:</div><div class="metric-value">{result['EMPLOYER_DZPO'] if result['EMPLOYER_DZPO'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">ЗО:</div><div class="metric-value">{result['EMPLOYER_HEALTH'] if result['EMPLOYER_HEALTH'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">Общо:</div><div class="metric-value">{result['EMPLOYER_CONTRIBUTION_TOTAL'] if result['EMPLOYER_CONTRIBUTION_TOTAL'] is not None else '–'} лв.</div></div>
                </div>
                """, unsafe_allow_html=True)
            ...
            with col4:
                ...
                <div class="metric-box" style="background-color:#ede7f6;border:1px solid #b39ddb;">
                    ...
                    <div class="metric-row"><div class="metric-label">Сума по договора:</div><div class="metric-value">{result['CONTRACT_AMOUNT'] if result['CONTRACT_AMOUNT'] is not None else '–'} лв.</div></div>
                    <div class="metric-row"><div class="metric-label">Чиста сума за получаване:</div><div class="metric-value">{result['NET_AMOUNT'] if result['NET_AMOUNT'] is not None else '–'} лв.</div></div>
